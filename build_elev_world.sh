...
for i in "${!elevations[@]}"
do
  echo "Running: python interpolate.py ${elevations[$i]} wnd.4Xday.1981-2010.ltm.nc elev/world/$i"
  eval "python interpolate.py ${elevations[$i]} wnd.4Xday.1981-2010.ltm.nc elev/world/$i &"
  echo "Completed building file for $i ft"
done
